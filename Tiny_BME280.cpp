 ...
 */
Tiny_BME280::Tiny_BME280() {}

Tiny_BME280::~Tiny_BME280(void) {
  if (temp_sensor) {
    delete temp_sensor;
  }
  if (pressure_sensor) {
 ...
 */
bool Tiny_BME280::begin(uint8_t addr, TwoWire *theWire) {
  bool status = false;
  _i2caddr = addr;
  _wire = theWire;
  status = init();
 ...
 */
void Tiny_BME280::setSampling(sensor_mode mode,
 ...
 */
void Tiny_BME280::write8(byte reg, byte value) {
 ...
 */
uint8_t Tiny_BME280::read8(byte reg) {
  uint8_t value;
 ...
 */
uint16_t Tiny_BME280::read16(byte reg) {
  uint16_t value;
 ...
 *   @returns the 16 bit data value read from the device
 */
uint16_t Tiny_BME280::read16_LE(byte reg) {
 ...
 *   @returns the 16 bit data value read from the device
 */
int16_t Tiny_BME280::readS16(byte reg) { return (int16_t)read16(reg); }
 ...
 *   @returns the 16 bit data value read from the device
 */
int16_t Tiny_BME280::readS16_LE(byte reg) {
 ...
 */
uint32_t Tiny_BME280::read24(byte reg) {
  uint32_t value;
 ...
 */
void Tiny_BME280::takeForcedMeasurement() {
 ...
 */
void Tiny_BME280::readCoefficients(void) {
 ...
 */
bool Tiny_BME280::isReadingCalibration(void) {
 ...
 */
float Tiny_BME280::readTemperature(void) {
  int32_t var1, var2;
 ...
 */
float Tiny_BME280::readPressure(void) {
  int64_t var1, var2, p;
 ...
 */
float Tiny_BME280::readHumidity(void) {
  readTemperature(); // must be done first to get t_fine
 ...
 */
float Tiny_BME280::readAltitude(float seaLevel) {
 ...
 */
float Tiny_BME280::seaLevelForAltitude(float altitude, float atmospheric) {
 ...
 */
uint32_t Tiny_BME280::sensorID(void) { return _sensorID; }

/*!
    @brief  Gets an Adafruit Unified Sensor object for the temp sensor component
    @return Adafruit_Sensor pointer to temperature sensor
 */
Adafruit_Sensor *Tiny_BME280::getTemperatureSensor(void) {
  if (!temp_sensor) {
    temp_sensor = new Tiny_BME280_Temp(this);
  }
 ...
 */
Adafruit_Sensor *Tiny_BME280::getPressureSensor(void) {
  if (!pressure_sensor) {
    pressure_sensor = new Tiny_BME280_Pressure(this);
  }
 ...
 */
Adafruit_Sensor *Tiny_BME280::getHumiditySensor(void) {
  if (!humidity_sensor) {
    humidity_sensor = new Tiny_BME280_Humidity(this);
  }
...
*/
/**************************************************************************/
void Tiny_BME280_Temp::getSensor(sensor_t *sensor) {
...
*/
/**************************************************************************/
bool Tiny_BME280_Temp::getEvent(sensors_event_t *event) {
  /* Clear the event */
...
*/
/**************************************************************************/
void Tiny_BME280_Pressure::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t));
...
*/
/**************************************************************************/
bool Tiny_BME280_Pressure::getEvent(sensors_event_t *event) {
  /* Clear the event */
  memset(event, 0, sizeof(sensors_event_t));
...
*/
/**************************************************************************/
void Tiny_BME280_Humidity::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t));
...
*/
/**************************************************************************/
bool Tiny_BME280_Humidity::getEvent(sensors_event_t *event) {
  /* Clear the event */
  memset(event, 0, sizeof(sensors_event_t));
