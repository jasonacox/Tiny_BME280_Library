...
class Tiny_BME280_Temp : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the temp sensor
      @param parent A pointer to the BME280 class */
  Tiny_BME280_Temp(Tiny_BME280 *parent) { _theBME280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);

private:
  int _sensorID = 280;
  Tiny_BME280 *_theBME280 = NULL;
};

/** Adafruit Unified Sensor interface for pressure component of BME280 */
class Tiny_BME280_Pressure : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the pressure sensor
      @param parent A pointer to the BME280 class */
  Tiny_BME280_Pressure(Tiny_BME280 *parent) { _theBME280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
...
class Tiny_BME280_Humidity : public Adafruit_Sensor {
public:
  /** @brief Create an Adafruit_Sensor compatible object for the humidity sensor
      @param parent A pointer to the BME280 class */
  Tiny_BME280_Humidity(Tiny_BME280 *parent) { _theBME280 = parent; }
  bool getEvent(sensors_event_t *);
  void getSensor(sensor_t *);
...
protected:
  ...
  Tiny_BME280_Temp *temp_sensor = NULL;
  //!< Adafruit_Sensor compat temperature sensor component

  Tiny_BME280_Pressure *pressure_sensor = NULL;
  //!< Adafruit_Sensor compat pressure sensor component

  Tiny_BME280_Humidity *humidity_sensor = NULL;
